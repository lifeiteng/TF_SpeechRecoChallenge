...
from tensorflow.python.layers import layers as layers_core
    ...
    with arg_scope(
      ...
      with variable_scope.variable_scope('Logits'):
        if global_pool:
          ...
          net_avg = math_ops.reduce_mean(net, [1, 2], keep_dims=True, name='global_avg_pool')
          net_max = math_ops.reduce_max(net, [1, 2], keep_dims=True, name='global_max_pool')
        ...
        logits = layers.conv2d(
          ...
          normalizer_fn=None,
          scope='Conv2d_1c_1x1')
        logits = layers_core.dense(array_ops.squeeze(logits, [1, 2], name='SpatialSqueeze'),
